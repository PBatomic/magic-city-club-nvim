...
function M.apply(p)
	...
	set_hl("Function", { fg = p.func, bold = true })
	...
	set_hl("DiffChange", { fg = p.keyword, bg = p.bg2 })
	...
	-- NvimTree
	set_hl("NvimTreeNormal", { fg = p.fg, bg = p.bg2 })
	set_hl("NvimTreeEndOfBuffer", { fg = p.bg2, bg = p.bg2 })
	set_hl("NvimTreeFolderName", { fg = p.keyword, bold = true })
	set_hl("NvimTreeOpenedFolderName", { fg = p.keyword, bold = true })
	set_hl("NvimTreeEmptyFolderName", { fg = p.fg3 })
	set_hl("NvimTreeFolderIcon", { fg = p.const })
	set_hl("NvimTreeIndentMarker", { fg = p.bg4 })
	set_hl("NvimTreeExecFile", { fg = p.func, bold = true })
	set_hl("NvimTreeSpecialFile", { fg = p.const, italic = true })
	set_hl("NvimTreeImageFile", { fg = p.str })
	set_hl("NvimTreeSymlink", { fg = p.builtin, italic = true })
	...
	set_hl("NeoTreeGitModified", { fg = p.keyword })
